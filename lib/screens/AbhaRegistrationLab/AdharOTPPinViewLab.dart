...
class AdharOTPPinViewLab extends StatefulWidget {
  // final String email;
  MainModel model;
  ...
  @override
  _AdharOTPPinViewLabState createState() => new _AdharOTPPinViewLabState();
}

class _AdharOTPPinViewLabState extends State<AdharOTPPinViewLab>
        ...
        fun: (Map<String, dynamic> map) {
          ...
          if (map.containsKey("txnId")) {
           ...
           // Navigator.pushNamed(context, "/abharegform");
            Navigator.pushNamed(context, "/abhaMobileLab");
          } else {
