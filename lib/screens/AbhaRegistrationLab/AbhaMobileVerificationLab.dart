...
class AbhaMobileVerificationLab extends StatefulWidget {
  // MainModel _model = MainModel();
  // LoginScreen(this._model);

  final MainModel model;

  const AbhaMobileVerificationLab({
    Key key,
    this.model,
  }) : super(key: key);
  ...
  @override
  _AbhaMobileVerificationLabState createState() => _AbhaMobileVerificationLabState();
}

class _AbhaMobileVerificationLabState extends State<AbhaMobileVerificationLab> {
    ...
    widget.model.POSTMETHOD_TOKEN(
        ...
        fun: (Map<String, dynamic> map) {
          ...
          if (map.containsKey("txnId")) {
            ...
            Navigator.pushNamed(context, "/phoneOTPLab");
          } else {
  ...
  void initState() {
    ...
    super.initState();
    AbhaMobileVerificationLab.countryModel = null;
    AbhaMobileVerificationLab.stateModel = null;
    AbhaMobileVerificationLab.districtModel = null;
    AbhaMobileVerificationLab.cityModel = null;
        ...
        children: [
          ...
          Column(
            ...
            children: [
                ...
                child: SizedBox(
                  ...
                  child: DropDown.networkDropdownGetpartUserundreline1(
                    ...
                    setState(() {
                      ...
                      AbhaMobileVerificationLab.countryModel = data;
                      AbhaMobileVerificationLab.stateModel = null;
                      AbhaMobileVerificationLab.districtModel = null;
                      AbhaMobileVerificationLab.cityModel = null;
                    });
                  ...
                  child: DropDown.countryList(
                    //"State",
                      ...
                      ApiFactory.STATE_API +
                          AbhaMobileVerificationLab.countryModel.key,
                      "stateabh",
                      Icons.location_on_rounded,
                      23.0, (KeyvalueModel data) {
                    setState(() {
                      AbhaMobileVerificationLab.stateModel = data;
                      AbhaMobileVerificationLab.districtModel = null;
                      AbhaMobileVerificationLab.cityModel = null;
                  ...
                  child: DropDown.countryList(
                    //"District",
                      ...
                      ApiFactory.DISTRICT_API +
                          AbhaMobileVerificationLab.stateModel.key,
                      "districtabh",
                      Icons.location_on_rounded,
                      23.0, (KeyvalueModel data) {
                    setState(() {
                      print(ApiFactory.COUNTRY_API);
                      AbhaMobileVerificationLab.districtModel = data;
                      AbhaMobileVerificationLab.cityModel = null;
                    });
                  }),
                ),
                ...
                child: SizedBox(
                  ...
                  child: DropDown.countryList(
                    //"City",
                      ...
                      ApiFactory.CITY_API +
                          AbhaMobileVerificationLab.districtModel.key,
                      "cityabh",
                      Icons.location_on_rounded,
                      23.0, (KeyvalueModel data) {
                    setState(() {
                      AbhaMobileVerificationLab.cityModel = data;
                      /*userModel.state=data.key;
                                      userModel.stateCode=data.code;*/
                    });
                  }),
              ...
              InkWell(
                onTap: () {
                  if (AbhaMobileVerificationLab.countryModel == null) {
                    AppData.showInSnackBar(context, "Please select country");
                  } else if (AbhaMobileVerificationLab.stateModel == null) {
                    AppData.showInSnackBar(context, "Please select state");
                  } else if (AbhaMobileVerificationLab.districtModel == null) {
                    AppData.showInSnackBar(context, "Please select district");
                  } else if (AbhaMobileVerificationLab.cityModel == null) {
