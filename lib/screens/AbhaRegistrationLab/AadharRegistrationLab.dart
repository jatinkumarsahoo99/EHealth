...
class AadharRegistrationLab extends StatefulWidget {
  // MainModel _model = MainModel();
  // LoginScreen(this._model);

  final MainModel model;

  const AadharRegistrationLab({Key key, this.model,}) : super(key: key);

  @override
  _AadharRegistrationLabState createState() => _AadharRegistrationLabState();
}

class _AadharRegistrationLabState extends State<AadharRegistrationLab> {
    ...
    widget.model.POSTMETHOD_TOKEN(
        ...
        fun: (Map<String, dynamic> map) {
          ...
          if (map.containsKey("txnId")) {
            ...
            Navigator.pushNamed(context, "/aadharOTPViewLab");
          } else {
