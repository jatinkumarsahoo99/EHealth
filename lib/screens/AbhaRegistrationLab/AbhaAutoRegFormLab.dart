...
class AbhaAutoRegFormLab extends StatefulWidget {
  final MainModel model;

  const AbhaAutoRegFormLab({Key key, this.model}) : super(key: key);

  @override
  _AbhaAutoRegFormLabState createState() => _AbhaAutoRegFormLabState();
}

class _AbhaAutoRegFormLabState extends State<AbhaAutoRegFormLab> {
    ...
    widget.model.POSTMETHOD_TOKEN(
        ...
        fun: (Map<String, dynamic> map) {
          ...
          if (!map.containsKey("message")) {
            ...
            userModel.country = AbhaMobileVerificationLab.countryModel.key;
            userModel.countryCode = AbhaMobileVerificationLab.countryModel.code;
            userModel.stateCode = AbhaMobileVerificationLab.stateModel.code;
            userModel.state = AbhaMobileVerificationLab.stateModel.key;
            userModel.districtid = AbhaMobileVerificationLab.districtModel.key;
            userModel.cityid = AbhaMobileVerificationLab.cityModel.key;
                ...
                child: Column(
                  children: [
                    ...
                    ListTile(
                      title: Text("Country"),
                      subtitle:
                      Text(AbhaMobileVerificationLab.countryModel.name),
                    ),
                    Divider(
                      thickness: 2,
                    ),
                    ListTile(
                      title: Text("State"),
                      subtitle:
                      Text(AbhaMobileVerificationLab.stateModel.name),
                    ),
                    Divider(
                      thickness: 2,
                    ),
                    ListTile(
                      title: Text("Dist"),
                      subtitle:
                      Text(AbhaMobileVerificationLab.districtModel.name),
                    ),
                    Divider(
                      thickness: 2,
                    ),
                    ListTile(
                      title: Text("City"),
                      subtitle:
                      Text(AbhaMobileVerificationLab.cityModel.name),
                    ),
                    SizedBox(height: 10),
                  ],
                ),
