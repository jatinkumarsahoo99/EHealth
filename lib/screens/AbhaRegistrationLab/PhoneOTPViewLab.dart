...
class PhoneOTPViewLab extends StatefulWidget {
  // final String email;
  MainModel model;
  ...
  @override
  _PhoneOTPViewLabState createState() => new _PhoneOTPViewLabState();
}

class _PhoneOTPViewLabState extends State<PhoneOTPViewLab>
    ...
    widget.model.POSTMETHOD_TOKEN(
      ...
      fun: (Map<String, dynamic> map) {
        ...
        if (map.containsKey("txnId")) {
          ...
          Navigator.pushNamed(context, "/finalAbhaLab");
        } else {
