...
class _TestAppointmentPageState extends State<TestAppointmentPage>
  ...
  createPdf(File _image,int count) async{
    ...
    try{
      if (await Permission.storage.request().isGranted){
        ...
        log(folder.path);
        var file = File('${folder.path}/writzoFile${DateTime.now().toString()}.pdf');
      ...
      */
        if (result != null) {
          try {
            ...
            log(">>>>>>>>>>>>>>>>>>>>file data"+ AppData.getExt(document[0].result));
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            AppData.showInSnackBar(context, "UnderConstruction 🚧 ");
                          },
                          child: ListTile(
                              leading: Icon(Icons.medical_services),
  ...
  callApi() {
    widget.model.GETMETHODCAL(api: "https://jsonkeeper.com/b/9GUA", fun: (Map<String,dynamic> map){
...
*/    if(result != null) {
        ...
        AyuRythmDataModel ayuRythmDataModel = AyuRythmDataModel.fromJson(
            json.decode(json.encode(map)));
        AyuRythmPostModel ayuRythmPostModel = AyuRythmPostModel(data: Data(
            type: null,
            foodTypes: null,
            herbs: null,
            kriya: null,
        ...
        if (data_auyrthm[3] != "null" &&
          ...
          Vikriti.fromJson(
              jsonDecode(data_auyrthm[3]));
        }
        else {
          ayuRythmPostModel.prakriti = Vikriti(kapha: "23",pitta: '23',vata: "34");
        }
        if (data_auyrthm[1] != "null" &&
          ...
          ayuRythmPostModel.sparshna = Sparshna(bala: null,
              bmi: 23,
              bmr: 34,
              bpm: 34,
              dp: 34,
        ...
        if (data_auyrthm[2] != "null" &&
          ...
          ayuRythmPostModel.vikriti = Vikriti(kapha: '56',pitta: "45",vata: "67");
        }
        log(">>>>>>>>>>>data_converted" +
          ...
          return Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Container(
                  child: Padding(
                    padding:  const EdgeInsets.only(left: 8.0, right: 8.0, bottom: 0,top: 0),
                    child: TextFormField(
                      decoration: InputDecoration(
                        hintText: "DOB:",
                      ),
      ...
      actions: <Widget>[
        ...
        new FlatButton(
          onPressed: () {
            ...
            } else if (double.tryParse(height.text) > 200) {
